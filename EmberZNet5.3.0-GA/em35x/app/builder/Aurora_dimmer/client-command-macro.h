...
/** @brief Sends transparent command to the end device.
 *
 * Cluster: Basic, Attributes for determining basic information about a device, setting user device information such as location, and enabling a device.
 * Command: SendTransparentCommand
 * @param payload int8u*
 * @param payloadLen int16u
 */
#define emberAfFillCommandBasicClusterSendTransparentCommand(payload, \
                                                             payloadLen) \
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                ...
                                                ZCL_BASIC_CLUSTER_ID, \
                                                0x1010, \
                                                ZCL_SEND_TRANSPARENT_COMMAND_COMMAND_ID, \
                                                "b", \
                                                payload, \
                                                payloadLen);


/** @brief This is the response to the SendTransparentCommand. (Or may be sent Unsolicited to COO).
 *
 * Cluster: Basic, Attributes for determining basic information about a device, setting user device information such as location, and enabling a device.
 * Command: SendTransparentCommandResponse
 * @param payload int8u*
 * @param payloadLen int16u
 */
#define emberAfFillCommandBasicClusterSendTransparentCommandResponse(payload, \
                                                                     payloadLen) \
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                 | ZCL_MANUFACTURER_SPECIFIC_MASK \
                                                 | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT), \
                                                ZCL_BASIC_CLUSTER_ID, \
                                                0x1010, \
                                                ZCL_SEND_TRANSPARENT_COMMAND_RESPONSE_COMMAND_ID, \
                                                "b", \
                                                payload, \
                                                payloadLen);
