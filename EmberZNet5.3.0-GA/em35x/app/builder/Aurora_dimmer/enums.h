...
#define EMBER_AF_MESSAGING_CONTROL_MASK_RESERVED (0x70)
#define EMBER_AF_MESSAGING_CONTROL_MASK_RESERVED_OFFSET (4)
#define EMBER_AF_MESSAGING_CONTROL_MASK_CONFIRMATION (0x80)
#define EMBER_AF_MESSAGING_CONTROL_MASK_CONFIRMATION_OFFSET (7)
#define EMBER_AF_PRICE_CONTROL_MASK_ACKNOWLEDGEMENT (0x01)
#define EMBER_AF_PREPAYMENT_PAYMENT_CONTROL_DISCONNECTION_ENABLED (0x01)
#define EMBER_AF_PREPAYMENT_PAYMENT_CONTROL_CREDIT_MANAGEMENT_ENABLED (0x04)
#define EMBER_AF_PREPAYMENT_PAYMENT_CONTROL_CREDIT_MANAGEMENT_ENABLED_OFFSET (2)
#define EMBER_AF_PREPAYMENT_PAYMENT_CONTROL_CREDIT_DISPLAY_ENABLED (0x10)
#define EMBER_AF_PREPAYMENT_PAYMENT_CONTROL_CREDIT_DISPLAY_ENABLED_OFFSET (4)
#define EMBER_AF_PREPAYMENT_PAYMENT_CONTROL_ACCOUNT_BASE (0x40)
#define EMBER_AF_PREPAYMENT_PAYMENT_CONTROL_ACCOUNT_BASE_OFFSET (6)
#define EMBER_AF_PREPAYMENT_PAYMENT_CONTROL_CONTACTOR_FITTED (0x80)
#define EMBER_AF_PREPAYMENT_PAYMENT_CONTROL_CONTACTOR_FITTED_OFFSET (7)
#define EMBER_AF_PREPAYMENT_CREDIT_STATUS_CREDIT_OK (0x01)
#define EMBER_AF_PREPAYMENT_CREDIT_STATUS_LOW_CREDIT (0x02)
#define EMBER_AF_PREPAYMENT_CREDIT_STATUS_LOW_CREDIT_OFFSET (1)
#define EMBER_AF_PREPAYMENT_CREDIT_STATUS_EMERGENCY_CREDIT_ENABLED (0x04)
#define EMBER_AF_PREPAYMENT_CREDIT_STATUS_EMERGENCY_CREDIT_ENABLED_OFFSET (2)
#define EMBER_AF_PREPAYMENT_CREDIT_STATUS_EMERGENCY_CREDIT_AVAILABLE (0x08)
#define EMBER_AF_PREPAYMENT_CREDIT_STATUS_EMERGENCY_CREDIT_AVAILABLE_OFFSET (3)
#define EMBER_AF_PREPAYMENT_CREDIT_STATUS_EMERGENCY_CREDIT_SELECTED (0x10)
#define EMBER_AF_PREPAYMENT_CREDIT_STATUS_EMERGENCY_CREDIT_SELECTED_OFFSET (4)
#define EMBER_AF_PREPAYMENT_CREDIT_STATUS_EMERGENCY_CREDIT_IN_USE (0x20)
#define EMBER_AF_PREPAYMENT_CREDIT_STATUS_EMERGENCY_CREDIT_IN_USE_OFFSET (5)
#define EMBER_AF_PREPAYMENT_CREDIT_STATUS_EMERGENCY_CREDIT_EXHAUSTED (0x40)
#define EMBER_AF_PREPAYMENT_CREDIT_STATUS_EMERGENCY_CREDIT_EXHAUSTED_OFFSET (6)
#define EMBER_AF_PREPAYMENT_SUPPLY_CONTROL_ACKNOWLEDGE_REQUIRED (0x01)
#define EMBER_AF_PREPAYMENT_ORIGINATOR_ID_SUPPLY_CONTROL_SUPPLY_CONTROL (0xF0)
#define EMBER_AF_PREPAYMENT_ORIGINATOR_ID_SUPPLY_CONTROL_SUPPLY_CONTROL_OFFSET (4)
#define EMBER_AF_PREPAYMENT_ORIGINATOR_ID_SUPPLY_CONTROL_ORIGINATOR_ID (0x0F)
...
#define EMBER_AF_BLOCK_PERIOD_DURATION_DURATION (0x3FFFFF)
#define EMBER_AF_BLOCK_PERIOD_DURATION_UNITS (0xC00000)
#define EMBER_AF_BLOCK_PERIOD_DURATION_UNITS_OFFSET (22)
#define EMBER_AF_NUMBER_OF_PRICE_TIERS_AND_NUMBER_OF_BLOCK_THRESHOLDS_NUMBER_OF_BLOCK_THRESHOLDS (0x0F)
#define EMBER_AF_NUMBER_OF_PRICE_TIERS_AND_NUMBER_OF_BLOCK_THRESHOLDS_NUMBER_OF_PRICE_TIERS (0xF0)
#define EMBER_AF_NUMBER_OF_PRICE_TIERS_AND_NUMBER_OF_BLOCK_THRESHOLDS_NUMBER_OF_PRICE_TIERS_OFFSET (4)
#define EMBER_AF_BLOCK_PERIOD_CONTROL_PRICE_ACKNOWLEDGEMENT (0x00)
#define EMBER_AF_BLOCK_PERIOD_CONTROL_REPEATING_BLOCK (0x01)
#define EMBER_AF_BLOCK_PERIOD_CONTROL_TARIFF_TYPE (0xF0)
#define EMBER_AF_BLOCK_PERIOD_CONTROL_TARIFF_TYPE_OFFSET (4)
...
#define EMBER_AF_MESSAGE_CONTROL_TRANSMISSION (0x03)
#define EMBER_AF_MESSAGE_CONTROL_IMPORTANCE (0x0C)
#define EMBER_AF_MESSAGE_CONTROL_IMPORTANCE_OFFSET (2)
#define EMBER_AF_MESSAGE_CONTROL_PIN_REQUIRED (0x10)
#define EMBER_AF_MESSAGE_CONTROL_PIN_REQUIRED_OFFSET (4)
#define EMBER_AF_MESSAGE_CONTROL_MESSAGE_ACCEPTANCE (0x20)
#define EMBER_AF_MESSAGE_CONTROL_MESSAGE_ACCEPTANCE_OFFSET (5)
#define EMBER_AF_MESSAGE_CONTROL_MESSAGE_CONFIRMATION (0x80)
#define EMBER_AF_MESSAGE_CONTROL_MESSAGE_CONFIRMATION_OFFSET (7)
#define EMBER_AF_NOTIFICATION_CONTROL_FLAGS_MIRROR_REPORT_ATTRIBUTE_RESPONSE (0x01)
#define EMBER_AF_NOTIFICATION_CONTROL_FLAGS_CHANGE_REPORTING_PROFILE (0x02)
#define EMBER_AF_NOTIFICATION_CONTROL_FLAGS_CHANGE_REPORTING_PROFILE_OFFSET (1)
...
#define EMBER_AF_FUNCTIONAL_NOTIFICATION_FLAGS_NEW_PASSWORD (0x00000008)
#define EMBER_AF_FUNCTIONAL_NOTIFICATION_FLAGS_NEW_PASSWORD_OFFSET (3)
#define EMBER_AF_FUNCTIONAL_NOTIFICATION_FLAGS_STAY_AWAKE_REQUEST_HAN (0x00000040)
#define EMBER_AF_FUNCTIONAL_NOTIFICATION_FLAGS_STAY_AWAKE_REQUEST_HAN_OFFSET (6)
#define EMBER_AF_FUNCTIONAL_NOTIFICATION_FLAGS_STAY_AWAKE_REQUEST_HES (0x00000080)
#define EMBER_AF_FUNCTIONAL_NOTIFICATION_FLAGS_STAY_AWAKE_REQUEST_HES_OFFSET (7)
#define EMBER_AF_PRICE_NOTIFICATION_FLAGS_PUBLISH_PRICE (0x00000001)
#define EMBER_AF_PRICE_NOTIFICATION_FLAGS_PUBLISH_BLOCK_PERIOD (0x00000002)
#define EMBER_AF_PRICE_NOTIFICATION_FLAGS_PUBLISH_BLOCK_PERIOD_OFFSET (1)
#define EMBER_AF_PRICE_NOTIFICATION_FLAGS_PUBLISH_TARIFF_INFORMATION (0x00000004)
#define EMBER_AF_PRICE_NOTIFICATION_FLAGS_PUBLISH_TARIFF_INFORMATION_OFFSET (2)
#define EMBER_AF_PRICE_NOTIFICATION_FLAGS_PUBLISH_CONVERSION_FACTOR (0x00000008)
#define EMBER_AF_PRICE_NOTIFICATION_FLAGS_PUBLISH_CONVERSION_FACTOR_OFFSET (3)
#define EMBER_AF_PRICE_NOTIFICATION_FLAGS_PUBLISH_CALORIFIC_VALUE (0x00000010)
#define EMBER_AF_PRICE_NOTIFICATION_FLAGS_PUBLISH_CALORIFIC_VALUE_OFFSET (4)
#define EMBER_AF_PRICE_NOTIFICATION_FLAGS_PUBLISH_C_O2_VALUE (0x00000020)
#define EMBER_AF_PRICE_NOTIFICATION_FLAGS_PUBLISH_C_O2_VALUE_OFFSET (5)
#define EMBER_AF_PRICE_NOTIFICATION_FLAGS_PUBLISH_BILLING_PERIOD (0x00000040)
#define EMBER_AF_PRICE_NOTIFICATION_FLAGS_PUBLISH_BILLING_PERIOD_OFFSET (6)
#define EMBER_AF_PRICE_NOTIFICATION_FLAGS_PUBLISH_CONSOLIDATED_BILL (0x00000080)
#define EMBER_AF_PRICE_NOTIFICATION_FLAGS_PUBLISH_CONSOLIDATED_BILL_OFFSET (7)
#define EMBER_AF_CALENDAR_NOTIFICATION_FLAGS_PUBLISH_CALENDAR (0x00000001)
#define EMBER_AF_CALENDAR_NOTIFICATION_FLAGS_PUBLISH_SPECIAL_DAYS (0x00000002)
#define EMBER_AF_CALENDAR_NOTIFICATION_FLAGS_PUBLISH_SPECIAL_DAYS_OFFSET (1)
#define EMBER_AF_CALENDAR_NOTIFICATION_FLAGS_PUBLISH_SEASONS (0x00000004)
#define EMBER_AF_CALENDAR_NOTIFICATION_FLAGS_PUBLISH_SEASONS_OFFSET (2)
#define EMBER_AF_CALENDAR_NOTIFICATION_FLAGS_PUBLISH_WEEK (0x00000008)
#define EMBER_AF_CALENDAR_NOTIFICATION_FLAGS_PUBLISH_WEEK_OFFSET (3)
#define EMBER_AF_CALENDAR_NOTIFICATION_FLAGS_PUBLISH_DAY (0x00000010)
#define EMBER_AF_CALENDAR_NOTIFICATION_FLAGS_PUBLISH_DAY_OFFSET (4)
#define EMBER_AF_PRE_PAY_NOTIFICATION_FLAGS_SELECT_AVAILABLE_EMERGENCY_CREDIT (0x00000001)
#define EMBER_AF_PRE_PAY_NOTIFICATION_FLAGS_CHANGE_DEBT (0x00000002)
#define EMBER_AF_PRE_PAY_NOTIFICATION_FLAGS_CHANGE_DEBT_OFFSET (1)
#define EMBER_AF_PRE_PAY_NOTIFICATION_FLAGS_EMERGENCY_CREDIT_SETUP (0x00000004)
#define EMBER_AF_PRE_PAY_NOTIFICATION_FLAGS_EMERGENCY_CREDIT_SETUP_OFFSET (2)
#define EMBER_AF_PRE_PAY_NOTIFICATION_FLAGS_CONSUMER_TOP_UP (0x00000008)
#define EMBER_AF_PRE_PAY_NOTIFICATION_FLAGS_CONSUMER_TOP_UP_OFFSET (3)
#define EMBER_AF_PRE_PAY_NOTIFICATION_FLAGS_CREDIT_ADJUSTMENT (0x00000010)
#define EMBER_AF_PRE_PAY_NOTIFICATION_FLAGS_CREDIT_ADJUSTMENT_OFFSET (4)
#define EMBER_AF_PRE_PAY_NOTIFICATION_FLAGS_CHANGE_PAYMENT_MODE (0x00000020)
#define EMBER_AF_PRE_PAY_NOTIFICATION_FLAGS_CHANGE_PAYMENT_MODE_OFFSET (5)
#define EMBER_AF_PRE_PAY_NOTIFICATION_FLAGS_GET_PREPAY_SNAPSHOT (0x00000040)
#define EMBER_AF_PRE_PAY_NOTIFICATION_FLAGS_GET_PREPAY_SNAPSHOT_OFFSET (6)
#define EMBER_AF_DEVICE_MANAGEMENT_NOTIFICATION_FLAGS_PUBLISH_CHANGEOF_TENANCY (0x00000001)
#define EMBER_AF_DEVICE_MANAGEMENT_NOTIFICATION_FLAGS_PUBLISH_CHANGEOF_SUPPLIER (0x00000002)
#define EMBER_AF_DEVICE_MANAGEMENT_NOTIFICATION_FLAGS_PUBLISH_CHANGEOF_SUPPLIER_OFFSET (1)
#define EMBER_AF_DEVICE_MANAGEMENT_NOTIFICATION_FLAGS_CHANGE_SUPPLY (0x00000004)
#define EMBER_AF_DEVICE_MANAGEMENT_NOTIFICATION_FLAGS_CHANGE_SUPPLY_OFFSET (2)
#define EMBER_AF_CHANGE_REPORTING_PROFILE_DURATION (0x3FFFFF)
#define EMBER_AF_CHANGE_REPORTING_PROFILE_UNITS (0xC00000)
#define EMBER_AF_CHANGE_REPORTING_PROFILE_UNITS_OFFSET (22)
...
#define EMBER_AF_SNAPSHOT_CAUSE_CHANGE_OF_TOU_CALENDAR (0x00000100)
#define EMBER_AF_SNAPSHOT_CAUSE_CHANGE_OF_TOU_CALENDAR_OFFSET (8)
...
#define EMBER_AF_PREPAYMENT_ALARM_CODE_LOW_CREDIT_WARNING (0x0001)
#define EMBER_AF_PREPAYMENT_ALARM_CODE_TOP_UP_CODE_ERROR (0x0002)
#define EMBER_AF_PREPAYMENT_ALARM_CODE_TOP_UP_CODE_ERROR_OFFSET (1)
#define EMBER_AF_PREPAYMENT_ALARM_CODE_TOP_UP_CODE_ALREADY_USED (0x0004)
#define EMBER_AF_PREPAYMENT_ALARM_CODE_TOP_UP_CODE_ALREADY_USED_OFFSET (2)
#define EMBER_AF_PREPAYMENT_ALARM_CODE_TOP_UP_CODE_INVALID (0x0008)
#define EMBER_AF_PREPAYMENT_ALARM_CODE_TOP_UP_CODE_INVALID_OFFSET (3)
#define EMBER_AF_PREPAYMENT_ALARM_CODE_FRIENDLY_CREDIT_IN_USE (0x0010)
#define EMBER_AF_PREPAYMENT_ALARM_CODE_FRIENDLY_CREDIT_IN_USE_OFFSET (4)
#define EMBER_AF_PREPAYMENT_ALARM_CODE_FRIENDLY_CREDIT_PERIOD_END_WARNING (0x0020)
#define EMBER_AF_PREPAYMENT_ALARM_CODE_FRIENDLY_CREDIT_PERIOD_END_WARNING_OFFSET (5)
#define EMBER_AF_PREPAYMENT_ALARM_CODE_EC_AVAILABLE (0x0040)
#define EMBER_AF_PREPAYMENT_ALARM_CODE_EC_AVAILABLE_OFFSET (6)
#define EMBER_AF_PREPAYMENT_ALARM_CODE_UNAUTHORISED_ENERGY_USE (0x0080)
#define EMBER_AF_PREPAYMENT_ALARM_CODE_UNAUTHORISED_ENERGY_USE_OFFSET (7)
#define EMBER_AF_PREPAYMENT_ALARM_CODE_DISCONNECTED_SUPPLY_DUE_TO_CREDIT (0x0100)
#define EMBER_AF_PREPAYMENT_ALARM_CODE_DISCONNECTED_SUPPLY_DUE_TO_CREDIT_OFFSET (8)
#define EMBER_AF_PREPAYMENT_ALARM_CODE_DISCONNECTED_SUPPLY_DUE_TO_TAMPER (0x0200)
#define EMBER_AF_PREPAYMENT_ALARM_CODE_DISCONNECTED_SUPPLY_DUE_TO_TAMPER_OFFSET (9)
#define EMBER_AF_PREPAYMENT_ALARM_CODE_DISCONNECTED_SUPPLY_DUE_TO_HES (0x0400)
#define EMBER_AF_PREPAYMENT_ALARM_CODE_DISCONNECTED_SUPPLY_DUE_TO_HES_OFFSET (10)
#define EMBER_AF_PREPAYMENT_ALARM_CODE_PHYSICAL_ATTACK (0x0800)
#define EMBER_AF_PREPAYMENT_ALARM_CODE_PHYSICAL_ATTACK_OFFSET (11)
#define EMBER_AF_PREPAYMENT_ALARM_CODE_ELECTRONIC_ATTACK (0x1000)
#define EMBER_AF_PREPAYMENT_ALARM_CODE_ELECTRONIC_ATTACK_OFFSET (12)
#define EMBER_AF_PREPAYMENT_ALARM_CODE_MANUFACTURE_ALARM_CODE_A (0x2000)
#define EMBER_AF_PREPAYMENT_ALARM_CODE_MANUFACTURE_ALARM_CODE_A_OFFSET (13)
#define EMBER_AF_PREPAYMENT_ALARM_CODE_MANUFACTURE_ALARM_CODE_B (0x4000)
#define EMBER_AF_PREPAYMENT_ALARM_CODE_MANUFACTURE_ALARM_CODE_B_OFFSET (14)
#define EMBER_AF_SNAPSHOT_PAYLOAD_CAUSE_GENERAL (0x0001)
#define EMBER_AF_SNAPSHOT_PAYLOAD_CAUSE_TOP_UP_ADDITION (0x0002)
#define EMBER_AF_SNAPSHOT_PAYLOAD_CAUSE_TOP_UP_ADDITION_OFFSET (1)
#define EMBER_AF_SNAPSHOT_PAYLOAD_CAUSE_DEBT_CREDIT_ADDITION (0x0004)
#define EMBER_AF_SNAPSHOT_PAYLOAD_CAUSE_DEBT_CREDIT_ADDITION_OFFSET (2)
#define EMBER_AF_SNAPSHOT_PAYLOAD_CAUSE_CHANGE_SUPPLIER (0x0008)
#define EMBER_AF_SNAPSHOT_PAYLOAD_CAUSE_CHANGE_SUPPLIER_OFFSET (3)
#define EMBER_AF_SNAPSHOT_PAYLOAD_CAUSE_CHANGE_TENANCY (0x0010)
#define EMBER_AF_SNAPSHOT_PAYLOAD_CAUSE_CHANGE_TENANCY_OFFSET (4)
...
#define EMBER_AF_PROPOSED_CHANGE_CONTROL_CLEAR_IPD_DATA_CONSUMER (0x00000200)
#define EMBER_AF_PROPOSED_CHANGE_CONTROL_CLEAR_IPD_DATA_CONSUMER_OFFSET (9)
#define EMBER_AF_PROPOSED_CHANGE_CONTROL_CLEAR_IPD_DATA_SUPPLIER (0x00000400)
#define EMBER_AF_PROPOSED_CHANGE_CONTROL_CLEAR_IPD_DATA_SUPPLIER_OFFSET (10)
