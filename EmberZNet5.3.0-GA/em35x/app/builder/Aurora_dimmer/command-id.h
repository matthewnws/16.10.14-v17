...
// Server to client
#define ZCL_SEND_TRANSPARENT_COMMAND_RESPONSE_COMMAND_ID 0x00 // Ver.: always mfgCode: 0x1010

// Client to server
#define ZCL_RESET_TO_FACTORY_DEFAULTS_COMMAND_ID 0x00 // Ver.: always
#define ZCL_SEND_TRANSPARENT_COMMAND_COMMAND_ID 0x00 // Ver.: always mfgCode: 0x1010
