...
void emAfOtaBootloadClusterClientResumeAfterErase(boolean success);
...
#if !defined(EMBER_AF_PLUGIN_AURORA_OTA_CLIENT_DOWNLOAD_DELAY_MS)
  ...
  // as fast as it can.
  #define EMBER_AF_PLUGIN_AURORA_OTA_CLIENT_DOWNLOAD_DELAY_MS  0L
#endif
...
#if defined(EMBER_AF_PLUGIN_AURORA_OTA_CLIENT_SERVER_DISCOVERY_DELAY_MINUTES)
  #define EMBER_AF_OTA_SERVER_DISCOVERY_DELAY_MS \
    (EMBER_AF_PLUGIN_AURORA_OTA_CLIENT_SERVER_DISCOVERY_DELAY_MINUTES * MINUTES_IN_MS)
#else
...
// available
#if defined(EMBER_AF_PLUGIN_AURORA_OTA_CLIENT_QUERY_DELAY_MINUTES)
  #define EMBER_AF_OTA_QUERY_DELAY_MS  \
    (EMBER_AF_PLUGIN_AURORA_OTA_CLIENT_QUERY_DELAY_MINUTES * MINUTES_IN_MS)
#else
...
#if !defined(EMBER_AF_PLUGIN_AURORA_OTA_CLIENT_QUERY_ERROR_THRESHOLD)
...
#if !defined(EMBER_AF_PLUGIN_AURORA_OTA_CLIENT_DOWNLOAD_ERROR_THRESHOLD)
...
#if defined(EMBER_AF_PLUGIN_AURORA_OTA_CLIENT_RUN_UPGRADE_REQUEST_DELAY_MINUTES)
  #define EMBER_AF_RUN_UPGRADE_REQUEST_DELAY_MS \
    (EMBER_AF_PLUGIN_AURORA_OTA_CLIENT_RUN_UPGRADE_REQUEST_DELAY_MINUTES * MINUTES_IN_MS)
#else
...
#if !defined(EMBER_AF_PLUGIN_AURORA_OTA_CLIENT_UPGRADE_WAIT_THRESHOLD)
  #define EMBER_AF_PLUGIN_AURORA_OTA_CLIENT_UPGRADE_WAIT_THRESHOLD  10
#endif

#if !defined(EMBER_AF_PLUGIN_AURORA_OTA_CLIENT_PAGE_REQUEST_SIZE)
...
#if !defined(EMBER_AF_PLUGIN_AURORA_OTA_CLIENT_VERIFY_DELAY_MS)
  #define EMBER_AF_PLUGIN_AURORA_OTA_CLIENT_VERIFY_DELAY_MS    10L
#endif

#define NULL_EUI64 { 0, 0, 0, 0, 0, 0, 0, 0 }

// A NULL eui64 is an invalid signer.  It will never match.
#if !defined(EMBER_AF_PLUGIN_AURORA_OTA_CLIENT_SIGNER_EUI0)
  #define EMBER_AF_PLUGIN_AURORA_OTA_CLIENT_SIGNER_EUI0 NULL_EUI64
#endif

#if !defined(EMBER_AF_PLUGIN_AURORA_OTA_CLIENT_SIGNER_EUI1)
  #define EMBER_AF_PLUGIN_AURORA_OTA_CLIENT_SIGNER_EUI1 NULL_EUI64
#endif

#if !defined(EMBER_AF_PLUGIN_AURORA_OTA_CLIENT_SIGNER_EUI2)
  #define EMBER_AF_PLUGIN_AURORA_OTA_CLIENT_SIGNER_EUI2 NULL_EUI64
#endif
