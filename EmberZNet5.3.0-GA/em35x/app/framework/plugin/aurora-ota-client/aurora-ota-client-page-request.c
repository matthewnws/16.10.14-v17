...
#define BITS_PER_BITMASK 16
  ...
  static int16u PAGE_SIZE = EMBER_AF_PLUGIN_AURORA_OTA_CLIENT_PAGE_REQUEST_SIZE;
  ...
  #define PAGE_SIZE EMBER_AF_PLUGIN_AURORA_OTA_CLIENT_PAGE_REQUEST_SIZE
...
#define EMBER_AF_PLUGIN_AURORA_OTA_CLIENT_PAGE_REQUEST_TIMEOUT_MS \
  (EMBER_AF_PLUGIN_AURORA_OTA_CLIENT_PAGE_REQUEST_TIMEOUT_SECONDS * MILLISECOND_TICKS_PER_SECOND)
                                 ...
                                 int32u totalImageSize)
{
  ...
  return EMBER_AF_PLUGIN_AURORA_OTA_CLIENT_PAGE_REQUEST_TIMEOUT_MS;
}
...
{
  return pageRequestOffset + EMBER_AF_PLUGIN_AURORA_OTA_CLIENT_PAGE_REQUEST_SIZE;
}
...
#else  // !defined(EMBER_AF_PLUGIN_AURORA_OTA_CLIENT_PAGE_REQUEST_SUPPORT)
...
#endif // EMBER_AF_PLUGIN_AURORA_OTA_CLIENT_USE_PAGE_REQUEST
