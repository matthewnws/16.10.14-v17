...
// on level), redefine EMBER_AF_PLUGIN_AURORA_LEVEL_CONTROL_TICKS_PER_SECOND.
#ifndef EMBER_AF_PLUGIN_AURORA_LEVEL_CONTROL_TICKS_PER_SECOND
  #define EMBER_AF_PLUGIN_AURORA_LEVEL_CONTROL_TICKS_PER_SECOND 32
#endif
#define EMBER_AF_PLUGIN_AURORA_LEVEL_CONTROL_TICK_TIME \
  (MILLISECOND_TICKS_PER_SECOND / EMBER_AF_PLUGIN_AURORA_LEVEL_CONTROL_TICKS_PER_SECOND)
