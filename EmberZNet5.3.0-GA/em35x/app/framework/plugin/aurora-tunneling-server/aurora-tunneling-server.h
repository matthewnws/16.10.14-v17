...
boolean emberAfPluginAuroraTunnelingServerIsProtocolSupportedCallback(int8u protocolId, int16u manufacturerCode);
void emberAfPluginAuroraTunnelingServerTunnelOpenedCallback(int16u tunnelId, int8u protocolId, int16u manufacturerCode,
                                                            boolean flowControlSupport, int16u maximumIncomingTransferSize);
void emberAfPluginAuroraTunnelingServerTunnelClosedCallback(int16u tunnelId, boolean clientInitiated);
void emberAfPluginAuroraTunnelingServerDataReceivedCallback(int16u tunnelId, int8u* data, int16u dataLen);
